---
name: minimax-pdf
description: Use this skill when visual quality and design identity matter for a PDF. CREATE (generate from scratch), FILL (complete form fields), or REFORMAT (apply design to an existing doc). Uses token-based design system.
license: MIT
metadata:
  version: "1.0"
