...
describe('MessageStore', () => {
  ...
  test('getRecent() filters by userId when provided', async () => {
    ...
    const store = new MessageStore();
    store.append({ userId: 'user-1', agentId: null, content: 'A from user-1', mentions: [], timestamp: 1 });
    store.append({ userId: 'user-2', agentId: null, content: 'B from user-2', mentions: [], timestamp: 2 });
    store.append({ userId: 'user-1', agentId: 'opus', content: 'C from user-1 opus', mentions: [], timestamp: 3 });
  ...
  test('getMentionsFor() filters by userId when provided', async () => {
    ...
    const store = new MessageStore();
    store.append({ userId: 'user-1', agentId: null, content: '@opus from user-1', mentions: ['opus'], timestamp: 1 });
    store.append({ userId: 'user-2', agentId: null, content: '@opus from user-2', mentions: ['opus'], timestamp: 2 });
  ...
  test('getByThread() keeps scheduler-triggered agent responses visible for a different user', async () => {
    ...
    assert.equal(visible[1].agentId, 'opus');
  ...
  test('getBefore() returns messages before timestamp', async () => {
    ...
    const store = new MessageStore();
    store.append({ userId: 'u', agentId: null, content: 'old', mentions: [], timestamp: 100 });
    store.append({ userId: 'u', agentId: null, content: 'mid', mentions: [], timestamp: 200 });
    store.append({ userId: 'u', agentId: null, content: 'new', mentions: [], timestamp: 300 });
  ...
  test('getBefore() filters by userId', async () => {
    ...
    const store = new MessageStore();
    store.append({ userId: 'alice', agentId: null, content: 'alice old', mentions: [], timestamp: 100 });
    store.append({ userId: 'bob', agentId: null, content: 'bob old', mentions: [], timestamp: 150 });
    store.append({ userId: 'alice', agentId: null, content: 'alice new', mentions: [], timestamp: 200 });
  ...
  test('append() defaults threadId to "default"', async () => {
    const { MessageStore, DEFAULT_THREAD_ID } = await import(
      '../dist/domains/agents/services/stores/ports/MessageStore.js'
    );
  ...
  test('getByThread() returns messages for a specific thread', async () => {
    ...
    const store = new MessageStore();
    store.append({ userId: 'u', agentId: null, content: 'A', mentions: [], timestamp: 1, threadId: 'th-1' });
    store.append({ userId: 'u', agentId: null, content: 'B', mentions: [], timestamp: 2, threadId: 'th-2' });
    store.append({ userId: 'u', agentId: null, content: 'C', mentions: [], timestamp: 3, threadId: 'th-1' });
    store.append({ userId: 'u', agentId: null, content: 'D', mentions: [], timestamp: 4 }); // default thread
  ...
  test('getByThreadBefore() paginates within a thread', async () => {
    ...
    const store = new MessageStore();
    store.append({ userId: 'u', agentId: null, content: 'A', mentions: [], timestamp: 100, threadId: 'th-1' });
    store.append({ userId: 'u', agentId: null, content: 'B', mentions: [], timestamp: 200, threadId: 'th-1' });
    store.append({ userId: 'u', agentId: null, content: 'C', mentions: [], timestamp: 300, threadId: 'th-1' });
    store.append({ userId: 'u', agentId: null, content: 'X', mentions: [], timestamp: 250, threadId: 'th-2' }); // different thread
  ...
  test('getByThread() includes scheduler messages when filtering by userId', async () => {
    ...
    const store = new MessageStore();
    store.append({ userId: 'user-1', agentId: 'opus', content: 'hello', mentions: [], timestamp: 1, threadId: 'th' });
    store.append({
      userId: 'scheduler',
      agentId: 'system',
    ...
    store.append({ userId: 'user-2', agentId: null, content: 'other user', mentions: [], timestamp: 3, threadId: 'th' });
  ...
  test('getByThreadBefore() includes scheduler messages when filtering by userId', async () => {
    ...
    const store = new MessageStore();
    store.append({ userId: 'user-1', agentId: 'opus', content: 'hello', mentions: [], timestamp: 100, threadId: 'th' });
    store.append({
      userId: 'scheduler',
      agentId: 'system',
      content: '[定时任务] reminder',
    ...
    store.append({ userId: 'user-1', agentId: null, content: 'follow-up', mentions: [], timestamp: 300, threadId: 'th' });
  ...
  test('getByThreadAfter() includes scheduler messages when filtering by userId', async () => {
    ...
    store.append({ userId: 'user-2', agentId: null, content: 'other', mentions: [], timestamp: 300, threadId: 'th' });
  ...
  test('P1: forged userId=scheduler with non-system agentId does NOT bypass filter', async () => {
    const { MessageStore } = await import('../dist/domains/agents/services/stores/ports/MessageStore.js');

    const store = new MessageStore();
    store.append({ userId: 'user-1', agentId: 'opus', content: 'legit', mentions: [], timestamp: 1, threadId: 'th' });
    store.append({
      userId: 'scheduler',
      agentId: 'opus',
  ...
  test('getByThread() includes system messages persisted with agentId=null when filtering by userId', async () => {
    const { MessageStore } = await import('../dist/domains/agents/services/stores/ports/MessageStore.js');

    const store = new MessageStore();
    store.append({ userId: 'user-1', agentId: null, content: 'hello', mentions: [], timestamp: 1, threadId: 'th' });
    store.append({
      userId: 'system',
      agentId: null,
    ...
    assert.equal(msgs[1].agentId, null);
  });
});
