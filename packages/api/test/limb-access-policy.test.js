...
describe('LimbAccessPolicy', () => {
  ...
  it('check returns authLevel when policy set', () => {
    const policy = new LimbAccessPolicy();
    policy.setPolicy({ agentId: 'opus', nodeId: 'iphone-1', capability: 'camera', authLevel: 'gated' });
  ...
  it('different cats have independent policies', () => {
    const policy = new LimbAccessPolicy();
    policy.setPolicy({ agentId: 'opus', nodeId: 'iphone-1', capability: 'camera', authLevel: 'free' });
    policy.setPolicy({ agentId: 'codex', nodeId: 'iphone-1', capability: 'camera', authLevel: 'gated' });
