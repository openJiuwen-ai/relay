...
describe('invocation-state-machine', () => {
  /** @type {typeof import('../dist/domains/agents/services/stores/ports/invocation-state-machine.js')} */
  let mod;

  test('module loads', async () => {
    mod = await import('../dist/domains/agents/services/stores/ports/invocation-state-machine.js');
