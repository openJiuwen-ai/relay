...
describe('catTagToAgentId', () => {
  it('maps Claude to opus', () => {
    assert.strictEqual(catTagToAgentId('Claude'), 'opus');
  });

  it('maps Codex to codex', () => {
    assert.strictEqual(catTagToAgentId('Codex'), 'codex');
  });

  it('maps Gemini to gemini', () => {
    assert.strictEqual(catTagToAgentId('Gemini'), 'gemini');
  });
});
