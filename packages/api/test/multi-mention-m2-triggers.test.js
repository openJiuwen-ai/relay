...
describe('F086 M2: Meta-thinking trigger documentation', () => {
  const sharedRules = readFileSync(resolve(__dirname, '../../../office-claw-skills/refs/shared-rules.md'), 'utf-8');
  ...
  it('feat-lifecycle contains Design Gate 先搜现状 check', () => {
    const featLifecycle = readFileSync(resolve(__dirname, '../../../office-claw-skills/feat-lifecycle/SKILL.md'), 'utf-8');
  ...
  it('collaborative-thinking references trigger rules', () => {
    const collabThinking = readFileSync(
      resolve(__dirname, '../../../office-claw-skills/collaborative-thinking/SKILL.md'),
      'utf-8',
    );
