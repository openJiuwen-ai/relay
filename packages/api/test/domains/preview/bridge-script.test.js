...
describe('bridge-script', () => {
  ...
  it('does not include legacy ppt selection bridge code', () => {
    assert.equal(BRIDGE_SCRIPT.includes('ppt-selection'), false);
    assert.equal(BRIDGE_SCRIPT.includes('ppt-select-request'), false);
  });
