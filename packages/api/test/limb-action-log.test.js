...
describe('LimbActionLog', () => {
  ...
  it('evicts oldest when at capacity', () => {
    ...
    smallLog.start({ invocationId: 'i2', leaseId: null, agentId: 'opus', nodeId: 'n1', capability: 'c', command: 'cmd' });
    smallLog.start({ invocationId: 'i3', leaseId: null, agentId: 'opus', nodeId: 'n1', capability: 'c', command: 'cmd' });
