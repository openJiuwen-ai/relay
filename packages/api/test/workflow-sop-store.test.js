...
describe('RedisWorkflowSopStore', { skip: !REDIS_URL ? 'REDIS_URL not set' : false }, () => {
  ...
  before(async () => {
    ...
    const storeModule = await import('../dist/domains/agents/services/stores/redis/RedisWorkflowSopStore.js');
    RedisWorkflowSopStore = storeModule.RedisWorkflowSopStore;
    const portModule = await import('../dist/domains/agents/services/stores/ports/WorkflowSopStore.js');
