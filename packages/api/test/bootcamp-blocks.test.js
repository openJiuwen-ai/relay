...
describe('F087: Bootcamp Interactive Rich Block definitions', () => {
  it('catSelectionBlock has valid structure', async () => {
    const { catSelectionBlock } = await import('../dist/domains/agents/services/bootcamp/bootcamp-blocks.js');
  ...
  it('taskSelectionBlock has valid structure', async () => {
    const { taskSelectionBlock } = await import('../dist/domains/agents/services/bootcamp/bootcamp-blocks.js');
  ...
  it('uses icon keys instead of emoji for all bootcamp options', async () => {
    const { taskSelectionBlock, catSelectionBlock } = await import(
      '../dist/domains/agents/services/bootcamp/bootcamp-blocks.js'
    );
  ...
  it('BOOTCAMP_BLOCKS registry contains all blocks', async () => {
    const { BOOTCAMP_BLOCKS } = await import('../dist/domains/agents/services/bootcamp/bootcamp-blocks.js');
