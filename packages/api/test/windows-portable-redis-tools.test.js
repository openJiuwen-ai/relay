...
test('Windows installer helpers do not mount OfficeClaw skills into external CLI skill directories', () => {
  assert.doesNotMatch(helpersScript, /function Mount-InstallerSkills/);
  assert.doesNotMatch(helpersScript, /function Get-InstallerSkillLinkTarget/);
  assert.doesNotMatch(helpersScript, /\$env:USERPROFILE\\\.claude/);
  assert.doesNotMatch(helpersScript, /\$env:USERPROFILE\\\.codex/);
  assert.doesNotMatch(helpersScript, /\$env:USERPROFILE\\\.gemini/);
  assert.doesNotMatch(helpersScript, /mklink \/J/);
});
