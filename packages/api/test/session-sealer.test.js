...
describe('SessionSealer', () => {
  ...
  describe('reconcileAllStuck()', () => {
    test('reaps stuck sealing sessions across multiple cats/threads', async () => {
      ...
      const r2 = store.create({ cliSessionId: 'cli-2', threadId: 'thread-2', agentId: 'codex', userId: 'user-1' });
      const r3 = store.create({ cliSessionId: 'cli-3', threadId: 'thread-3', agentId: 'gemini', userId: 'user-1' });
