...
import {
  ...
  isValidRichBlock,
  normalizeRichBlock,
} from '../dist/domains/agents/services/agents/routing/rich-block-extract.js';
...
\`\`\``;
  ...
  // P0 security: reject arbitrary local paths (prevents file exfiltration via connector uploads)
