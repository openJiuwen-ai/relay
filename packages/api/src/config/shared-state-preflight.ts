 ...
 * Called from invoke-single-agent.ts before dispatching ANY agent (Claude/Codex/Gemini).
 *
...
const SHARED_STATE_PATTERN = /^(docs\/ROADMAP\.md|docs\/ROADMAP\.md|agent-template\.json|agent-config\.json)$/;
