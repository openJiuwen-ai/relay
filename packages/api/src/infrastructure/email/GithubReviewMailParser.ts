...
export function extractAgentFromTitle(title: string): AgentTag | null {
...
/**
 * Map agent tag to agent ID used in the system.
 */
export function agentTagToAgentId(tag: AgentTag): string {
  switch (tag) {
    case 'Claude':
      return 'opus';
    case 'Codex':
