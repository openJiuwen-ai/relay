 ...
 * ARGV[1..7] = id, threadId, userId, targetAgents(JSON), intent, idempotencyKey, now
 */
...
redis.call('HSET', KEYS[2],
  ...
  'targetAgents', ARGV[4], 'intent', ARGV[5],
...
export class RedisInvocationRecordStore implements IInvocationRecordStore {
  ...
  private hydrateRecord(data: Record<string, string>): InvocationRecord {
    ...
    return {
      ...
      targetAgents: safeParseArray(data.targetAgents) as AgentId[],
