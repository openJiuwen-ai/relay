...
import type { AuthorizationAuditEntry, AgentId, RespondScope } from '@openjiuwen/relay-shared';
...
export class RedisAuthorizationAuditStore implements IAuthorizationAuditStore {
  ...
  async list(filter?: { agentId?: AgentId; threadId?: string; limit?: number }): Promise<AuthorizationAuditEntry[]> {
