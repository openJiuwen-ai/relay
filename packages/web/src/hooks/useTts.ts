...
function synthesize(messageId: string, text: string, agentId?: string): void {
...
export interface UseTtsReturn {
  state: TtsState;
  synthesize: (messageId: string, text: string, agentId?: string) => void;
  stop: () => void;
  activeMessageId: string | null;
}
...
export function useTts(): UseTtsReturn {
  ...
  const stableSynthesize = useCallback(
    (messageId: string, text: string, agentId?: string) => synthesize(messageId, text, agentId),
    [],
  );
