...
const CDN_BASE = (readPublicEnv('NEXT_PUBLIC_JSDELIVR_HOST') || 'https://cdn.jsdelivr.net').replace(/\/+$/, '');
const ONNX_WASM_CDN = `${CDN_BASE}/npm/onnxruntime-web@1.22.0/dist/`;
const VAD_ASSETS_CDN = `${CDN_BASE}/npm/@ricky0123/vad-web@0.0.30/dist/`;
