...
import { RangeField, SectionCard, SelectField, TextField } from './hub-agent-editor-fields';
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <SelectField
          ...
          onChange={(value) => onChange({ sessionChain: value as HubAgentEditorFormState['sessionChain'] })}
          tone="success"
        />
