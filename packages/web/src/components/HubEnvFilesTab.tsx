...
// Must stay in sync with the API-side sensitive-file denylist.
 ...
 * - file: inside project root but no longer openable after workspace sunset
 * - dir-inside: directory in project root but no longer openable after workspace sunset
...
function PathAction({
  ...
  switch (classification.kind) {
    case 'file':
    case 'dir-inside':
      return <RestrictedPathLabel absPath={absPath} reason="workspace 能力已下线，无法在 Hub 中打开" />;
    case 'denied':
...
const RESTART_REQUIRED_ENV_VARS = new Set(['API_SERVER_PORT']);
