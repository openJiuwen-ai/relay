...
export function AudioBlock({ block, agentId }: { block: RichAudioBlock; agentId?: string }) {
  ...
  if (isVoiceMessage) {
    const colors = (agentId ? CAT_VOICE_COLORS[agentId] : undefined) ?? DEFAULT_VOICE_COLORS;
