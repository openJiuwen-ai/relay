 ...
 */
export function TokenCacheBar({ percent, agentId }: TokenCacheBarProps) {
  ...
  const gradient = CAT_GRADIENTS[agentId] ?? CAT_GRADIENTS.opus;

  return (
    <div className="flex items-center gap-1.5" data-testid={`cache-bar-${agentId}`}>
